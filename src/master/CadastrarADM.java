...
public class CadastrarADM extends JFrame {
    ...
    JTextField log1 = new JTextField();
    
    JLabel sen = new JLabel("Senha: ");
    JPasswordField sen1 = new JPasswordField();
    ...
    public CadastrarADM() {
        ...
        setTitle("Cadastrar ADMINISTRADORES");
        setSize(620, 350);
        setVisible(true);
       ...
       // setResizable(false);
        ...
        dia.setBounds(150, 80, 65, 30);
        mes.setBounds(240, 80, 65, 30);
        ano.setBounds(330, 80, 65, 30);
        ...
        sen.setBounds(410, 135, 100, 30);
        sen1.setBounds(460, 135, 120, 30);
        
        log.setBounds(410, 80, 100, 30);
        log1.setBounds(460, 80, 120, 30);
                            ...
                            if (rg1.getText().isEmpty()) {
                                ...
                                if (cpf1.getText().isEmpty()) {
                                    ...
                                    if (log1.getText().isEmpty()) {
                                        ...
                                        fun = new funcionarios(nome1.getText(), (String) sexo1.getSelectedItem(),
                                                data, rg1.getText(), cpf1.getText(),
                                                "Administrador",log1.getText(), sen1.getText());

                                        DAO.adiciona_Fun(fun);
                                        ...
                                        if (s == JOptionPane.YES_OPTION) {
                                            ...
                                            new CadastrarADM().setVisible(false);
                                            dispose();
                                        } else {
